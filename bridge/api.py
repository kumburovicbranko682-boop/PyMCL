...
class BackendAPI:
    ...
    def edit_world(self, instance: str, name: str, changes: dict, version: str = "") -> dict:
        from mclauncher import saves as saves_mod
        return saves_mod.edit_world(self._instance(instance), name, changes or {}, version)
    ...
    def add_offline_account(self, username: str, skin: str = "", uuid: str = ""):
        acc = self.accounts.offline_account(username, skin=skin or "default", uuid=uuid)
    ...
    def upload_skin(self, account_name: str, file_path: str, variant: str = "classic") -> str:
        return self.start_task("更换皮肤", self._upload_skin_impl,
